...
TroAddComponentAction("SCENE", "shelfer", function(inst, doer, actions, right)
...
TroAddComponentAction("SCENE", "shopped", function(inst, doer, actions, right)
...
TroAddComponentAction("POINT", "gasser", function(inst, doer, pos, actions, right)
...
TroAddComponentAction("EQUIPPED", "gasser", function(inst, doer, target, actions, right)
