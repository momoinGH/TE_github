...
TroAddRecipe("mermhouse_tropical_crafted", { Ig("boards", 5), Ig("cutreeds", 3), Ig("oceanfish_small_61_inv", 2) }, TECH.SCIENCE_ONE,
    {
        builder_tag = "merm_builder",
...
TroAddRecipe("quagmire_merm_house_crafted", { Ig("boards", 5), Ig("cutstone", 3), Ig("oceanfish_small_11_inv", 2) }, TECH.SCIENCE_ONE,
    {
        builder_tag = "merm_builder",
