...
TroAddRecipe("seatrap", { Ig("palmleaf", 4), Ig("messagebottleempty", 2), Ig("jellyfish", 1) }, TECH.SEAFARING_TWO, nil, { "TOOLS", "GARDENING", "NAUTICAL" })
...
TroAddRecipe("boat_lantern", { Ig("messagebottleempty", 1), Ig("twigs", 2), Ig("bioluminescence", 1) }, TECH.SCIENCE_TWO, nil, { "NAUTICAL", "LIGHT" })
...
TroAddRecipe("porto_buoy", { Ig("messagebottleempty", 1), Ig("bamboo", 4), Ig("bioluminescence", 2) }, TECH.SEAFARING_TWO, { image = "buoy.tex" }, { "LIGHT", "STRUCTURES", "NAUTICAL" })
TroAddRecipe("telescope", { Ig("goldnugget", 1), Ig("pigskin", 1), Ig("messagebottleempty", 1) }, TECH.SEAFARING_TWO, nil, { "TOOLS", "NAUTICAL" })
...
TroAddRecipe("armor_lifejacket", { Ig("fabric", 2), Ig("vine", 2), Ig("messagebottleempty", 2) }, TECH.SEAFARING_TWO, nil, { "CLOTHING", "NAUTICAL" })
...
TroAddRecipe("bottlelantern", { Ig("messagebottleempty", 1), Ig("bioluminescence", 2) }, TECH.SCIENCE_TWO, nil, { "LIGHT" })
...
TroAddRecipe("messagebottleempty_sw", { Ig("sand", 3) }, TECH.SCIENCE_TWO, { product = "messagebottleempty" }, { "REFINE" })
...
TroAddRecipe("gashat", { Ig("coral", 2), Ig("messagebottleempty", 2), Ig("jellyfish", 1) }, TECH.SCIENCE_TWO, nil, { "CLOTHING" })
