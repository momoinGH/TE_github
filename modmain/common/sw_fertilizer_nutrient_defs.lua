...
SW_FERTILIZER_DEFS.spoiled_fish_large = {nutrients = TUNING.SPOILED_FISH_LARGE_NUTRIENTS}
SW_FERTILIZER_DEFS.mysterymeat = {nutrients = TUNING.MYSTERYMEAT_NUTRIENTS}
