...
local IronLordStates =
{
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst:ForceFacePoint(inst.target and inst.target:GetPosition() or inst.tro_laser_targetpos)
            inst:PerformBufferedAction()
        end,
    ...
    State {
        ...
        onupdate = function(inst)
            inst:ForceFacePoint(inst.tro_laser_targetpos)
    ...
    State {
        ...
        timeline =
        {
            TimeEvent(1 * FRAMES, function(inst) shoot(inst, inst.target, inst.tro_laser_targetpos) end),
