...
local InventoryItems = {
	...
	lavaarena = { "amulet", "ancient_remnant", "antivenom", "boarbattle", "bossboarbattle", "cutgrass", "houndbattle", "knightbattle", "lizardbattle", "mermbattle", "reno_rug_tiles", "rhinocebrosbattle", "spiderbattle", "swineclopsbattle", "tfwp_crystal_crown_hat", "tfwp_dragon_dart", "tfwp_fire_bomb", "tfwp_flower_headband_hat", "tfwp_healing_staff", "tfwp_lava_dart", "tfwp_lava_hammer", "tfwp_luxury_nox_helm_hat", "tfwp_spear_gung", "tfwp_spear_lance", "tfwp_summon_book", "tfwp_wizard_crown_hat", "tfwp_woven_garland_hat", },
