...
AddComponentPostInit("birdspawner", function(self)
    if not BIRD_TYPES then
        ...
        if BIRD_TYPES then
            ...
            AddBirds(WORLD_TILES.DEEPRAINFOREST, { "parrot_blue", "kingfisher" })
            AddBirds(WORLD_TILES.FIELDS, { "robin", "crow" })
            AddBirds(WORLD_TILES.FOUNDATION, { "pigeon", "crow" })
            AddBirds(WORLD_TILES.GASRAINFOREST, { "parrot_blue" })
            --AddBirds(WORLD_TILES.LAWN, { "robin", "crow" })
            AddBirds(WORLD_TILES.SUBURB, { "robin", "crow", "pigeon" })
            AddBirds(WORLD_TILES.PAINTED, { "kingfisher", "crow" })
            --AddBirds(WORLD_TILES.PIGRUINS, { "robin", "crow" })
            AddBirds(WORLD_TILES.PLAINS, { "robin", "crow", "kingfisher" })
            AddBirds(WORLD_TILES.RAINFOREST, { "toucan_hamlet", "kingfisher", "parrot_blue" })
            ...
            AddBirds(WORLD_TILES.QUAGMIRE_PARKSTONE, { "robin", "quagmire_pigeon" })
            AddBirds(WORLD_TILES.QUAGMIRE_GATEWAY, { "robin", "quagmire_pigeon" })
            --AddBirds(WORLD_TILES.QUAGMIRE_SOIL, { "quagmire_pigeon" })
            AddBirds(WORLD_TILES.QUAGMIRE_CITYSTONE, { "quagmire_pigeon" })
