...
STRINGS.NAMES.WALLRENOVATION                              = "WALLRENOVATION"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.WALLRENOVATION        = "WALLRENOVATION描述"
STRINGS.RECIPE_DESC.WALLRENOVATION                        = "WALLRENOVATION配方"
