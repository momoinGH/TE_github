...
table.tromerge(SCHOOL_WEIGHTS[SEASONS.AUTUMN][WORLD_TILES.OCEAN_COASTAL], {
...
table.tromerge(SCHOOL_WEIGHTS[SEASONS.AUTUMN][WORLD_TILES.OCEAN_SWELL], {
...
table.tromerge(SCHOOL_WEIGHTS[SEASONS.AUTUMN][WORLD_TILES.OCEAN_ROUGH], {
    oceanfish_small_10 = SCHOOL_UNCOMMON,
    oceanfish_small_11 = SCHOOL_UNCOMMON,
})
table.tromerge(SCHOOL_WEIGHTS[SEASONS.AUTUMN][WORLD_TILES.OCEAN_BRINEPOOL], {
    oceanfish_small_13 = SCHOOL_UNCOMMON,
    oceanfish_small_14 = SCHOOL_UNCOMMON,
})
table.tromerge(SCHOOL_WEIGHTS[SEASONS.AUTUMN][WORLD_TILES.OCEAN_HAZARDOUS], {
    oceanfish_small_17 = SCHOOL_UNCOMMON,
    oceanfish_small_18 = SCHOOL_UNCOMMON,
})
table.tromerge(SCHOOL_WEIGHTS[SEASONS.AUTUMN][WORLD_TILES.OCEAN_WATERLOG], {
    oceanfish_small_17 = SCHOOL_UNCOMMON,
    oceanfish_small_18 = SCHOOL_UNCOMMON,
})
...
for _, data in pairs(FISH_DEFS) do
    ...
    AddPrefabPostInit(data.prefab, function(inst)
        if data.oceanbuild then
            ...
            inst.AnimState:SetBuild(data.oceanbuild)
        end
        ...
        if data.oceanbuild then
            ...
            inst.bank = data.bank or inst.build
            inst:SetStateGraph("SGoceanfishsw") --没办法，拷贝了一份稍微修改
        end
    end)
end
