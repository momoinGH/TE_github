...
AddComponentPostInit("birdspawner", function(self)
    if not BIRD_TYPES then
        ...
        if BIRD_TYPES then
            ...
            AddBirds(WORLD_TILES.RAINFOREST, { "toucan_hamlet", "kingfisher", "parrot_blue", "kingfisher_swarm",
                "toucan_hamlet_swarm", "parrot_blue_swarm" })
            AddBirds(WORLD_TILES.DEEPRAINFOREST, { "toucan_hamlet", "parrot_blue", "kingfisher", "kingfisher_swarm",
                "toucan_hamlet_swarm", "parrot_blue_swarm" })
            AddBirds(WORLD_TILES.GASJUNGLE, { "parrot_blue", "parrot_blue_swarm" })
            AddBirds(WORLD_TILES.FOUNDATION, { "quagmire_pigeon", "crow", "pigeon_swarm" })
            AddBirds(WORLD_TILES.FIELDS, { "robin", "crow" })
            AddBirds(WORLD_TILES.SUBURB, { "robin", "crow", "quagmire_pigeon", "pigeon_swarm" })
            ...
            AddBirds(WORLD_TILES.WATER_MANGROVE, { "robin_winter" })
