...
WIKI_DATA = {}
prosafemodimport("modmain/languages/strings_en") --英文版本兜底，不使用的台词不应该添加
prosafemodimport("modmain/languages/strings_" .. language)
prosafemodimport("modmain/languages/modwiki_zh") -- 其他语言的wiki先不管
