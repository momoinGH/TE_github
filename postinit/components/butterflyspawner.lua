...
local Spawner = require "components/butterflyspawner"
...
if ScheduleSpawn then
    ...
    if old_SpawnButterflyForPlayer then
        ...
        local _maxbutterflies = Util.FindUpvalue(old_SpawnButterflyForPlayer, "_maxbutterflies") or TUNING.MAX_BUTTERFLIES
