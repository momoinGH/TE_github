...
AddClassPostConstruct("components/butterflyspawner", function(Spawner)
    ...
    if ScheduleSpawn == nil then return end
    local GetSpawnPoint = Util.ChainFindUpvalue(ScheduleSpawn, "SpawnButterflyForPlayer", "GetSpawnPoint")
    local old_SpawnButterflyForPlayer, key = Util.FindUpvalue(ScheduleSpawn, "SpawnButterflyForPlayer")
    if GetSpawnPoint == nil or old_SpawnButterflyForPlayer == nil then return end
