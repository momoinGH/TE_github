...
return Prefab("common/objects/pig_ruins_dart", fn, assets, prefabs),
    ...
    darts("pig_ruins_pigman_relief_dart2", "interior_wall_decals_ruins", "interior_wall_decals_ruins", "relief_happy",
        "down"),
    darts("pig_ruins_pigman_relief_dart3", "interior_wall_decals_ruins", "interior_wall_decals_ruins", "relief_surprise",
        "down"),
    darts("pig_ruins_pigman_relief_dart4", "interior_wall_decals_ruins", "interior_wall_decals_ruins", "relief_head",
        "down"),
    darts("pig_ruins_pigman_relief_leftside_dart", "interior_wall_decals_ruins", "interior_wall_decals_ruins",
        "relief_sidewall", "right"),
    darts2("pig_ruins_pigman_relief_rightside_dart", "interior_wall_decals_ruins", "interior_wall_decals_ruins",
        "relief_sidewall", "left"),
    darts("pig_ruins_pigman_relief_dart1_blue", "interior_wall_decals_ruins_blue", "interior_wall_decals_ruins",
        "relief_confused", "down"),
    darts("pig_ruins_pigman_relief_dart2_blue", "interior_wall_decals_ruins_blue", "interior_wall_decals_ruins",
        "relief_happy", "down"),
    darts("pig_ruins_pigman_relief_dart3_blue", "interior_wall_decals_ruins_blue", "interior_wall_decals_ruins",
        "relief_surprise", "down"),
    darts("pig_ruins_pigman_relief_dart4_blue", "interior_wall_decals_ruins_blue", "interior_wall_decals_ruins",
        "relief_head", "down"),
    darts("pig_ruins_pigman_relief_leftside_dart_blue", "interior_wall_decals_ruins_blue", "interior_wall_decals_ruins",
        "relief_sidewall", "right"),
    darts2("pig_ruins_pigman_relief_rightside_dart_blue", "interior_wall_decals_ruins_blue", "interior_wall_decals_ruins",
        "relief_sidewall", "left")
