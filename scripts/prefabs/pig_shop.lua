...
local function creatInterior(inst)
    ...
    if inst.prefab == "pig_shop_academy" then
        ...
        addprops       = {
            { name = "pig_shop_giftshop_door", x_offset = 5, key = "exit", },
            { name = "deco_roomglow", },
            ...
            { name = "deco_accademy_beam", x_offset = -5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_accademy_beam", x_offset = -5, z_offset = -width / 2 },
            { name = "deco_accademy_cornerbeam", x_offset = 4.7, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_accademy_cornerbeam", x_offset = 4.7, z_offset = -width / 2 },

            { name = "swinging_light_floral_bulb", x_offset = -3, z_offset = -0 },

            { name = "deco_cityhall_picture1", z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_cityhall_picture2", z_offset = -width / 2 },

            { name = "deco_accademy_pig_king_painting", x_offset = -5, z_offset = 3, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_antiquities" then
        ...
        addprops       = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_antiquities", background = true },
            ...
            { name = "deco_roomglow", },
            { name = "shop_spawner", x_offset = -3, shop_type = name, },
            ...
            { name = "deco_antiquities_cornerbeam", x_offset = -5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_antiquities_cornerbeam", x_offset = -5, z_offset = -width / 2 },
            { name = "deco_antiquities_cornerbeam2", x_offset = 4.7, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            { name = "deco_antiquities_beefalo_side", z_offset = width / 2, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_hatshop" then
        ...
        addprops       = {
            ...
            { name = "deco_millinery_beam2", x_offset = 4.7, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_millinery_cornerbeam3", x_offset = -5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            { name = "hat_lamp_side", z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "picture_1", x_offset = -2.5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "picture_2", x_offset = 2.5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_weapons" then
        ...
        addprops       = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_basic", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            {
                name = "shelves_midcentury",
                x_offset = -4.5,
                z_offset = 4, --rotation = -90,
            ...
            { name = "deco_weapon_beam1", x_offset = -5, z_offset = width / 2, rotation = -90, animdata = { scale = { -1, 1 } } },
            { name = "deco_weapon_beam1", x_offset = -5, z_offset = -width / 2, rotation = -90 },
            { name = "deco_weapon_beam2", x_offset = 4.7, z_offset = width / 2, rotation = -90, animdata = { scale = { -1, 1 } } },
            ...
            { name = "deco_antiquities_beefalo_side", x_offset = -2, z_offset = width / 2, rotation = -90, animdata = { scale = { -1, 1 } } },
            ...
            { name = "shop_buyer", z_offset = 3.5, saveID = true, startAnim = "idle_cablespool" },
    ...
    elseif inst.prefab == "pig_shop_arcane" then
        ...
        addprops = {
            ...
            { name = "deco_roomglow", },
            { name = "shop_spawner", x_offset = -3, shop_type = name, saveID = true },
            ...
            { name = "deco_accademy_cornerbeam", x_offset = 4.7, z_offset = width / 2, rotation = -90, animdata = { scale = { -1, 1 } } },
            { name = "deco_accademy_cornerbeam", x_offset = 4.7, z_offset = -width / 2, rotation = -90 },
            { name = "deco_accademy_beam", x_offset = -5, z_offset = width / 2, rotation = -90, animdata = { scale = { -1, 1 } } },
            ...
            { name = "deco_antiquities_beefalo_side", z_offset = width / 2, rotation = -90, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_florist" then
        floortexture = "levels/textures/noise_woodfloor.tex"
        ...
        addprops = {
            ...
            { name = "deco_roomglow", },
            { name = "shop_spawner", shop_type = name },
            ...
            { name = "deco_florist_latice_side", z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            { name = "deco_florist_pillar_side", x_offset = 4.3, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_hoofspa" then
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_hoofspa", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_marble_cornerbeam", x_offset = -5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_marble_beam", x_offset = 4.7, z_offset = -width / 2 + 0.3 },
            { name = "deco_marble_beam", x_offset = 4.7, z_offset = width / 2 - 0.3, animdata = { scale = { -1, 1 } } },
            ...
            { name = "deco_valence", x_offset = -5.01, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            { name = "shop_buyer", x_offset = -0.5, startAnim = "idle_marble" },
    ...
    elseif inst.prefab == "pig_shop_general" then
        floortexture = "levels/textures/interiors/shop_floor_checker.tex"
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_general", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_roomglow", },
            { name = "deco_wood_cornerbeam", x_offset = -5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            { name = "shop_buyer", x_offset = 1.1, startAnim = "idle_cablespool" },
    ...
    elseif inst.prefab == "pig_shop_produce" then
        floortexture = "levels/textures/noise_woodfloor.tex"
        walltexture = "levels/textures/interiors/shop_wall_woodwall.tex"
        minimaptexture = "levels/textures/map_interior/mini_ruins_slab.tex"
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_produce", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_produce_stone_cornerbeam", x_offset = -5, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_deli" then
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_deli", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_deli_stove_metal_side", x_offset = -3, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_deli_wallpaper_rip_side1", x_offset = -1, z_offset = -width / 2 },
            { name = "deco_deli_wallpaper_rip_side2", x_offset = 2, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_cityhall" then
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_flag", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_cityhall_bookshelf", x_offset = -depth / 2, z_offset = -width / 3, animdata = { scale = { -1, 1 } } },

            { name = "deco_cityhall_cornerbeam", x_offset = -4.99, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_cityhall_cornerbeam", x_offset = -4.99, z_offset = -width / 2 },
            { name = "deco_cityhall_pillar", x_offset = 4.7, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_cityhall_pillar", x_offset = 4.7, z_offset = -width / 2 },

            { name = "deco_cityhall_picture1", x_offset = 1.3, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_cityhall_picture2", x_offset = -1.3, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
    ...
    elseif inst.prefab == "pig_shop_cityhall_player" then
        floortexture = "levels/textures/interiors/floor_cityhall.tex"
        walltexture = "levels/textures/interiors/wall_mayorsoffice_whispy.tex"
        minimaptexture = "levels/textures/map_interior/mini_ruins_slab.tex"
    ...
    elseif inst.prefab == "pig_shop_bank" then
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_bank", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_bank_marble_cornerbeam", x_offset = -4.99, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_bank_marble_cornerbeam", x_offset = -4.99, z_offset = -width / 2 },
            { name = "deco_bank_marble_beam", x_offset = 4.7, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_bank_marble_beam", x_offset = 4.7, z_offset = -width / 2 },

            { name = "deco_bank_clock1_side", x_offset = -depth / 4, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_bank_clock2_side", z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_bank_clock3_side", x_offset = depth / 4, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            { name = "deco_accademy_barrier_vert", x_offset = -2, z_offset = 5, animdata = { scale = { -1, 1 } } },
            { name = "deco_accademy_barrier_vert", x_offset = 2.3, z_offset = 5, animdata = { scale = { -1, 1 } } },

            { name = "shelves_displaycase_metal", x_offset = -2, z_offset = -width / 2 + 0.75, rotation = 90, animdata = { scale = { -1, 1 } }, shelfitems = { { 1, "flint" }, { 2, "rocks" }, { 3, "flint" } } },
            { name = "shelves_displaycase_metal", x_offset = -2, z_offset = width / 2 - 0.75, rotation = 90, shelfitems = { { 1, "rocks" }, { 2, "rocks" }, { 3, "rocks" } } },
            { name = "shelves_displaycase_metal", x_offset = 2.3, z_offset = -width / 2 + 0.75, rotation = 90, animdata = { scale = { -1, 1 } }, shelfitems = { { 1, "nitre" }, { 2, "nitre" }, { 3, "rocks" } } },
    ...
    elseif inst.prefab == "pig_shop_tinker" then
        ...
        addprops = {
            {
                ...
                animdata = { bank = "pig_shop_doormats", build = "pig_shop_doormats", anim = "idle_tinker", background = true },
                my_door_id = exterior_door_def.target_door_id,
                target_door_id = exterior_door_def.my_door_id,
                addtags = { "guard_entrance" },
                usesounds = { SHOPSOUND_EXIT }
            ...
            { name = "deco_tinker_cornerbeam", x_offset = -4.99, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            { name = "deco_tinker_cornerbeam", x_offset = -4.99, z_offset = -width / 2 },
            { name = "deco_tinker_beam", x_offset = 4.7, z_offset = width / 2, animdata = { scale = { -1, 1 } } },
            ...
            --    { name = "window_round_light",      x_offset = -depth/2,},
            ...
            { name = "deco_worktable", x_offset = 2.5, z_offset = 4, rotation = 90, animdata = { scale = { -1, 1 } } },

            { name = "deco_filecabinet", x_offset = -2.5, z_offset = -width / 2 },
            { name = "deco_rollholder", x_offset = 2, z_offset = -width / 2 + 0.7 },
            { name = "deco_rollholder", z_offset = width / 2 - 0.7, rotation = 90, animdata = { scale = { -1, 1 } } },
            { name = "deco_rollholder_front", x_offset = -depth / 2 + 0.3, z_offset = -4 },

        }
    end

    interior_spawner:CreateRoom("generic_interior", width, height, depth, name .. ID, ID, addprops, {}, walltexture, floortexture, minimaptexture, cityID,
        "images/colour_cubes/pigshop_interior_cc.tex", nil, nil, "inside", "STORE", "WOOD")
...
local function makefn(name, build, bank, data)
    ...
    local function fn()
        local inst = InteriorSpawnerUtils.MakeBaseDoor(bank or "pig_shop", build, "idle", false, false,
            name == "pig_shop_cityhall_player" and "pig_shop_cityhall.png" or name .. ".png")
