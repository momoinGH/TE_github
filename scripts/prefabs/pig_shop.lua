...
local rooms = {
    ...
    pig_shop_hatshop = {
        ...
        addprops = {
            ...
            { name = "swinging_light_rope_1", x_offset = -3, z_offset = width / 6 },
            { name = "window_round_burlap_backwall", x_offset = -depth / 2, z_offset = -5 },
            { name = "window_round_light_backwall", x_offset = -depth / 2, z_offset = -5 },
            { name = "window_round_burlap_backwall", x_offset = -depth / 2, z_offset = 5 },
            { name = "window_round_light_backwall", x_offset = -depth / 2, z_offset = 5 },
    ...
    pig_shop_weapons = {
        ...
        addprops = {
            ...
            { name = "shield_axes", x_offset = -depth / 2, },
    ...
    pig_shop_general = {
        ...
        addprops = {
            ...
            { name = "window_round", x_offset = 1.5, z_offset = width / 2, scale = { -1, 1 } },
            { name = "window_round_light", x_offset = 1.5, z_offset = width / 2, scale = { -1, 1 } },
    ...
    pig_shop_produce = {
        ...
        addprops = {
            ...
            { name = "deco_produce_menu", x_offset = -depth / 2, z_offset = width / 6 },
            { name = "window_round", x_offset = depth / 6, z_offset = width / 2, scale = { -1, 1 } },
            { name = "window_round", x_offset = -depth / 6, z_offset = width / 2, scale = { -1, 1 } },
            { name = "window_round_light", x_offset = depth / 6, z_offset = width / 2, scale = { -1, 1 } },
            { name = "window_round_light", x_offset = -depth / 6, z_offset = width / 2, scale = { -1, 1 } },
