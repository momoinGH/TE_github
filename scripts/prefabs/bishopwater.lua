...
local function UpdateShotFx(inst)
	if inst.AnimState:IsCurrentAnimation("atk_up") or
	   inst.AnimState:IsCurrentAnimation("atk_down") or
	   inst.AnimState:IsCurrentAnimation("atk_side")
	then
...
return MakeBishop("bishopwater", normal_common_postinit, normal_master_postinit, assets, prefabs),
       MakeBishop("bishopwaterfixo", normal_common_postinit, normal_master_postinit, assets, prefabs)
