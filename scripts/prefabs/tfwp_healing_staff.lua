...
local function m(e, n, k)
    e:DoTaskInTime(0.9, function()
        local o = e.heal_rate;
        local p = false;
        if n.components.buffable then
            o = (o + n.components.buffable:GetBuffData("spell_heal_rate")) *
                (n.components.buffable:GetBuffData("heal_dealt_mult") + 1)
            p = o > e.heal_rate
        end;
...
return CustomPrefab("tfwp_healing_staff", x, a, b, nil, "images/inventoryimages.xml", "healingstaff.tex",
    TUNING.FORGE_ITEM_PACK.TFWP_HEALING_STAFF, "swap_healingstaff", "common_hand")
