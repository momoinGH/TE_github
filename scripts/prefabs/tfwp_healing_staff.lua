...
local k=Vector3()
for l=6,0,-.25 do k.x,k.y,k.z=i.entity:LocalToWorldSpace(l,0,0)
if j:IsPassableAtPoint(k:Get()) and not j:IsGroundTargetBlocked(k) then return k 
end 
end;
return k 
end;
...
r.caster=n;
q.buffed=p;
e.components.recarregavel:StartRecharge()TheWorld:PushEvent("healingcircle_spawned")
