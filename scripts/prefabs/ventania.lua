...
local function OnInit(inst)
	...
	if palmtree then
		...
		if not palmtree:HasTag("burnt") and not palmtree:HasTag("stump") then
			...
			if math.random() > 0.5 then
				palmtree.AnimState:PushAnimation(palmtree.anims.blown1, true)
			else
				palmtree.AnimState:PushAnimation(palmtree.anims.blown2, true)
			end
			-----------------para de balancar------------------------------------------
	...
	if twiggytreesw then
		...
		if not twiggytreesw:HasTag("burnt") and not twiggytreesw:HasTag("stump") then
			...
			if math.random() > 0.5 then
				twiggytreesw.AnimState:PushAnimation(twiggytreesw.anims.blown1, true)
			else
				twiggytreesw.AnimState:PushAnimation(twiggytreesw.anims.blown2, true)
			end
			-----------------para de balancar------------------------------------------
	...
	if bambootree and bambootree:HasTag("machetecut") then
		...
		if bambootree.components.workable.action == ACTIONS.HACK then
			...
			if math.random() > 0.5 then
				bambootree.AnimState:PushAnimation("blown_loop1", true)
			else
				bambootree.AnimState:PushAnimation("blown_loop2", true)
			end
			-----------------para de balancar------------------------------------------
	...
	if bush_vine and bush_vine:HasTag("machetecut") then
		...
		if bush_vine.components.workable.action == ACTIONS.HACK then
			...
			if math.random() > 0.5 then
				bush_vine.AnimState:PushAnimation("blown_loop1", true)
			else
				bush_vine.AnimState:PushAnimation("blown_loop2", true)
			end
			-----------------para de balancar------------------------------------------
	...
	if grasss then
		...
		if grasss.components.pickable:CanBePicked() then
			...
			if math.random() > 0.5 then
				grasss.AnimState:PushAnimation("blown_loop1", true)
			else
				grasss.AnimState:PushAnimation("blown_loop2", true)
			end
			-----------------para de balancar------------------------------------------
	...
	if saplingsw then
		...
		if saplingsw.components.pickable:CanBePicked() then
			...
			if math.random() > 0.5 then
				saplingsw.AnimState:PushAnimation("blown_loop1", true)
			else
				saplingsw.AnimState:PushAnimation("blown_loop2", true)
			end
			-----------------para de balancar------------------------------------------
	...
	if grasstall and grasstall:HasTag("machetecut") then
		...
		if math.random() > 0.5 then
			grasstall.AnimState:PushAnimation("blown_loop1", true)
		else
			grasstall.AnimState:PushAnimation("blown_loop2", true)
		end
		-----------------para de balancar------------------------------------------
	...
	if tubertree then
		...
		if math.random() > 0.5 then
			tubertree.AnimState:PushAnimation("blown_loop_tall1", true)
		else
			tubertree.AnimState:PushAnimation("blown_loop_tall2", true)
		end
		-----------------para de balancar------------------------------------------
