...
local SPOILED_FISH_LARGE_NUTRIENTS = { 24, 0, 0 }
local MYSTERYMEAT_NUTRIENTS = { 24, 24, 24 }
SW_FERTILIZER_DEFS.spoiled_fish_large = { nutrients = SPOILED_FISH_LARGE_NUTRIENTS, uses = 1 }
SW_FERTILIZER_DEFS.mysterymeat = { nutrients = MYSTERYMEAT_NUTRIENTS, uses = 1 }
