...
local function ondropped(inst)
    ...
    if ground == WORLD_TILES.UNDERWATER_SANDY or ground == WORLD_TILES.UNDERWATER_ROCKY or (ground == WORLD_TILES.BEACH and TheWorld:HasTag("cave")) or (ground == WORLD_TILES.MAGMAFIELD and TheWorld:HasTag("cave")) or (ground == WORLD_TILES.PAINTED and TheWorld:HasTag("cave")) or (ground == WORLD_TILES.PEBBLEBEACH and TheWorld:HasTag("cave")) or (ground == WORLD_TILES.PIGRUINS and TheWorld:HasTag("cave")) then
