...
return
---------------------deco_swinging_light------------
    Prefab("swinging_light_basic_bulb", decofn("ceiling_lights", "ceiling_lights", "light_basic_bulb",
            { decal = true, loopanim = true, light = true, followlight = "electric_1", tags = { "NOBLOCK", "NOCLICK", "centerlight" }, onbuilt = true }),
        assets, prefabs),
    Prefab("swinging_light_floral_bloomer", decofn("ceiling_lights", "ceiling_lights", "light_floral_bloomer",
            { decal = true, loopanim = true, light = true, followlight = "electric_1", tags = { "NOBLOCK", "NOCLICK", "centerlight" }, onbuilt = true }),
        assets, prefabs),
    Prefab("swinging_light_basic_metal", decofn("ceiling_lights", "ceiling_lights", "light_basic_metal",
            { decal = true, loopanim = true, light = true, followlight = "electric_1", tags = { "NOBLOCK", "NOCLICK", "centerlight" }, onbuilt = true }),
        assets, prefabs),
