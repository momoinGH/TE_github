...
local RETARGET_CANT_TAGS = { "wall", "vampirebat" }
...
local function MakeWarg(name, bank, build, prefabs, tag)
    ...
    local function fn()
        ...
        inst.components.lootdropper:SetChanceLootTable("wargboar")
...
return MakeWarg("wargboar", "wargboar_actions", "wargboar", prefabs_basic, nil)
