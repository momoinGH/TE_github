...
--         -- 使用映射的符号名，如果没有则用食物名
--         local symbolName = data.anim or data.oldname or data.name
--         inst.AnimState:OverrideSymbol("bread", anim, symbolName)
...
-- local foods = require("gorge_preparedfoods")

-- for k, v in pairs(foods) do
--     -- 适配 gorge_preparedfoods 格式
--     v.name = v.name or k
--     v.health = v.health or 0
--     v.hunger = v.hunger or 0
--     v.sanity = v.sanity or 0
--     v.perishtime = v.perishtime or TUNING.PERISH_SLOW
--     v.platetype = v.dish or "plate"
--     -- 设置动画符号映射
