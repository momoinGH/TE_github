...
local function dig_up(inst)
    if inst.components.spawner:IsOccupied() then
        inst.components.lootdropper:SpawnLootPrefab("goddess_rabbit")
    end
...
local function fn()
    ...
    inst.components.spawner:Configure("goddess_rabbit", TUNING.RABBIT_RESPAWN_TIME)
...
return Prefab("goddess_rabbithole", fn, assets, prefabs)
