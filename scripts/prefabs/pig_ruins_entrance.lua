...
return Prefab("pig_ruins_entrance", makefn("pig_ruins_entrance", true, "RUINS_1"), assets, prefabs),
    Prefab("pig_ruins_exit", makefn2("pig_ruins_entrance", false, "RUINS_1"), assets, prefabs),
    Prefab("pig_ruins_entrance2", makefn("pig_ruins_entrance", true, "RUINS_2"), assets, prefabs),
    Prefab("pig_ruins_exit2", makefn2("pig_ruins_entrance", false, "RUINS_2"), assets, prefabs),
    ...
    Prefab("pig_ruins_exit4", makefn2("pig_ruins_entrance", false, "RUINS_4"), assets, prefabs),
    ...
    Prefab("pig_ruins_entrance6", makefn("pig_ruins_entrance", true, "RUINS_SMALL"), assets, prefabs)
