...
local function MoveToNewSpot(inst)
    ...
    movimento:Remove()
    if ground == WORLD_TILES.OCEAN_COASTAL then
        --ground == WORLD_TILES.OCEAN_COASTAL_SHORE or
        --ground == WORLD_TILES.OCEAN_SWELL then
...
local function fn()
    ...
    inst.components.minionspawner.validtiletypes = { WORLD_TILES.OCEAN_COASTAL, WORLD_TILES.OCEAN_WATERLOG, GROUND
        .OCEAN_COASTAL_SHORE, WORLD_TILES.OCEAN_SWELL, WORLD_TILES.OCEAN_ROUGH, WORLD_TILES.OCEAN_BRINEPOOL, GROUND
        .OCEAN_BRINEPOOL_SHORE, WORLD_TILES.OCEAN_HAZARDOUS }
