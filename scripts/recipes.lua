...
--Wurt
AddRecipe2("mermfishhouse_crafted", 	{Ingredient("boards", 5), Ingredient("cutreeds", 3), Ingredient("fish2", 2,v_atlas)}, 										TECH.SCIENCE_ONE, {builder_tag="merm_builder", 		atlas=v_atlas, placer="mermfishhouse_crafted_placer",  testfn=function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH or ground_tile == GROUND.QUAGMIRE_PEATFOREST) end}, {"CHARACTER"})
AddRecipe2("mermhouse_tropical_crafted", {Ingredient("boards", 4), Ingredient("cutreeds", 3), Ingredient("fish2", 2,v_atlas)}, 										TECH.SCIENCE_ONE, {builder_tag="merm_builder", 		atlas=v_atlas, placer="mermhouse_tropical_crafted_placer",  testfn=function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH or ground_tile == GROUND.QUAGMIRE_PEATFOREST) end}, {"CHARACTER"})
AddRecipe2("quagmire_merm_house_crafted", {Ingredient("boards", 2), Ingredient("cutstone", 4), Ingredient("salmon", 2,v_atlas)}, 									TECH.SCIENCE_ONE, {builder_tag="merm_builder", 		atlas=hm_atlas, placer="quagmire_merm_house_crafted_placer", image="quagmire_merm_house.png", testfn=function(pt, rot) local ground_tile = GLOBAL.TheWorld.Map:GetTileAtPoint(pt.x, pt.y, pt.z) return ground_tile and (ground_tile == GROUND.MARSH or ground_tile == GROUND.TIDALMARSH or ground_tile == GROUND.QUAGMIRE_PEATFOREST) end}, {"CHARACTER"})
...
--GORGE--
AddRecipe2("quagmire_swampig_house",    {Ingredient("boards", 4), Ingredient("rocks", 8), Ingredient("pigskin", 4)},  	TECH.GORGE_TWO, {atlas=hm_atlas, nounlock=true, image="quagmire_swampig_house.png", placer="quagmire_swampig_house_placer"}, {"GORGE"})
...
AddRecipe2("quagmire_safe",			 	{Ingredient("quagmire_coin1", 20)}, TECH.GORGE_TWO, {atlas=hm_atlas,  nounlock=true, image="quagmire_safe.png", placer="quagmire_safe_placer"}, {"GORGE"})
...
AddRecipe2("turf_quagmire_citystone",	{Ingredient("rocks", 2), Ingredient("saltrock", 1)},			                           TECH.TURFCRAFTING_ONE,  {numtogive=4, atlas="images/inventoryimages/novositens.xml"}, {"DECOR"})
