    ...
    State {
        ...
        timeline =
        {
            TimeEvent(4 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/elderdrake/clap") end),
            ...
            TimeEvent(28 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/elderdrake/clap") end),
            TimeEvent(34 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/elderdrake/clap") end),
            ...
            TimeEvent(46 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/elderdrake/clap") end),
            TimeEvent(52 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/elderdrake/clap") end),
    ...
    State {
        ...
        timeline =
        {
            TimeEvent(3 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/elderdrake/hit") end),
        },
...
CommonStates.AddWalkStates(states,
    {
        walktimeline = {
            ...
            TimeEvent(0 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/elderdrake/hop") end),
            TimeEvent(6 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/elderdrake/foley") end),
...
CommonStates.AddSleepStates(states,
    {
        ...
        {
            TimeEvent(35 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/elderdrake/sleep") end),
        },
    })
