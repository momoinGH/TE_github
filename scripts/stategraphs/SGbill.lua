...
local states =
{
	...
	State {
		...
		onenter = function(inst)
			...
			if inst.onwater then
				inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/platapine_bill/roll_water_LP",
					"water_tumbling")
			else
				inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/platapine_bill/roll_land_LP",
					"land_tumbling")
			end
		end,
