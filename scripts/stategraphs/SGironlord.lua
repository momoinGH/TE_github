...
local actionhandlers =
{
    ...
    ActionHandler(ACTIONS.TIRO, "charge"),
}
...
local function shoot(inst)
    if inst.fullcharge then
        ...
        beam.components.complexprojectile:SetHorizontalSpeed(26)
        beam.components.complexprojectile:SetGravity(-100)
...
CommonStates.AddCombatStates(states,
    {
        ...
        attacktimeline =
        {
            ...
            TimeEvent(8 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/crafted/iron_lord/punch") end),
