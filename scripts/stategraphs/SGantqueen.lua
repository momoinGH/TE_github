...
CommonStates.AddSleepStates(states,
    {
        ...
        {
            TimeEvent(35 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/boss/antqueen/breath_out") end),
        },

        sleeptimeline =
        {
            TimeEvent(6 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/boss/antqueen/breath_in") end),
            TimeEvent(36 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/boss/antqueen/breath_out") end),
        },
    },
