...
local events =
{
	EventHandler("attacked",
		function(inst) if not inst.components.health:IsDead() and not inst.sg:HasStateTag("attack") and not inst.sg:HasStateTag("busy") then
...
local states =
{
	...
	State {
		...
		timeline =
		{
			...
			TimeEvent(14 * FRAMES, function(inst)
				...
				inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/venus_flytrap/" ..
				inst.currentTransform .. "/attack")
			end),
	...
	State {
		...
		timeline =
		{
			TimeEvent(14 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
				"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/attack") end),
	...
	State {
		...
		onenter = function(inst, cb)
			...
			inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/venus_flytrap/" ..
			inst.currentTransform .. "/breath_out")
		end,
	...
	State {
		...
		timeline =
		{
			TimeEvent(10 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
				"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/taunt") end),
	...
	State {
		...
		timeline =
		{
			TimeEvent(1 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
				"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/death_pre", nil, .5) end),
			TimeEvent(13 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
				"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/death") end),
		},
	},
	...
	State {
		...
		{
			TimeEvent(1 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
				"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/death_pre") end),
...
CommonStates.AddSleepStates(states,
	{
		starttimeline = {
			TimeEvent(14 * FRAMES,
				function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/venus_flytrap/" ..
					inst.currentTransform .. "/step") end),
		},
		...
		sleeptimeline = {
			...
			TimeEvent(8 * FRAMES,
				function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/venus_flytrap/" ..
					inst.currentTransform .. "/breath_in") end),
			TimeEvent(20 * FRAMES,
				function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/venus_flytrap/" ..
					inst.currentTransform .. "/breath_out") end),
		},

		waketimeline = {
			TimeEvent(5 * FRAMES,
				function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/venus_flytrap/" ..
					inst.currentTransform .. "/wake") end),
		},
	})
...
CommonStates.AddRunStates(
	states,
	{
		runtimeline =
		{
			---fast		
			TimeEvent(5 * FRAMES,
				function(inst) if inst:HasTag("usefastrun") then inst.SoundEmitter:PlaySound(
						"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/breath_out") end end),
			TimeEvent(12 * FRAMES,
				function(inst) if inst:HasTag("usefastrun") then inst.SoundEmitter:PlaySound(
						"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/step") end end),
			---slow
			TimeEvent(19 * FRAMES,
				function(inst) if not inst:HasTag("usefastrun") then inst.SoundEmitter:PlaySound(
						"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/step") end end),
			TimeEvent(7 * FRAMES,
				function(inst) if not inst:HasTag("usefastrun") then inst.SoundEmitter:PlaySound(
						"dontstarve_DLC003/creatures/enemy/venus_flytrap/" .. inst.currentTransform .. "/breath_out") end end),
