...
local function destroystuff(inst)
    ...
    for i, v in ipairs(ents) do
        ...
        if v ~= inst.WINDSTAFF_CASTER and not v:HasTag("windy1") and not v:HasTag("windy2") and v:IsValid() then
            if v.components.health ~= nil and
                ...
                local damage =
                    ...
                    v:HasTag("player") and
                    TUNING.TORNADO_DAMAGE * TUNING.PVP_DAMAGE_MOD * 2 or
                    TUNING.TORNADO_DAMAGE * 2
