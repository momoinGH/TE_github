...
local states =
{
    ...
    State {
        ...
        timeline =
        {
            TimeEvent(9 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "turnoftides/common/together/water/submerge/medium", nil, .5) end),
            TimeEvent(18 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "turnoftides/common/together/water/emerge/medium", nil, .5) end),
    ...
    State {
        ...
        onenter = function(inst, target_info)
            ...
            inst:DoTaskInTime(0.34, function(inst)
                ...
                horn_attack_prefab.SoundEmitter:PlaySoundWithParams("turnoftides/common/together/boat/thunk",
                    { intensity = .8 })
            end)
        end,
    ...
    State {
        ...
        onenter = function(inst)
            ...
            local run_anim_time_remaining = inst.AnimState:GetCurrentAnimationTime() %
