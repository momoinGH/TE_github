    ...
    State {
        ...
        timeline =
        {
            TimeEvent(24 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/Peakcock/appear") end),
            ...
            TimeEvent(19 * FRAMES, function(inst) inst.SoundEmitter:PlaySound(
                "dontstarve_DLC003/creatures/Peakcock/appear_pop") end),
        },
...
CommonStates.AddRunStates(states,
    {
        ...
        {
            TimeEvent(0 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/Peakcock/move") end),
        },
...
CommonStates.AddSleepStates(states,
    {
        ...
        {
            TimeEvent(0 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/Peakcock/sleep") end),
        },
