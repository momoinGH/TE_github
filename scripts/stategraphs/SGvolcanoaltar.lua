		...
		timeline =
		{
			TimeEvent(13 * FRAMES, function(inst)
				inst.SoundEmitter:PlaySound(
					"dontstarve_DLC002/common/volcano_alter/slide_open")
			end),
			TimeEvent(15 * FRAMES, function(inst)
				inst.SoundEmitter:PlaySound(
					"dontstarve_DLC002/common/volcano_alter/open")
			end)
		},
	...
	State {
		...
		timeline =
		{
			TimeEvent(12 * FRAMES, function(inst)
				inst.SoundEmitter:PlaySound(
					"dontstarve_DLC002/common/volcano_alter/slide_close")
			end),
			TimeEvent(22 * FRAMES, function(inst)
				inst.SoundEmitter:PlaySound(
					"dontstarve_DLC002/common/volcano_alter/close")
			end)
		},
