            ...
            if inst.components.embarker:HasDestination() then
                ...
                elseif inst.sg.statemem.timeout then
                    ...
                    inst.sg:GoToState("hop_pst",
                        not TheWorld.Map:IsVisualGroundAtPoint(x, y, z) and TheWorld.Map:GetPlatformAtPoint(x, z) == nil)
                end
...
CommonStates.AddSleepStates(states,
    {
        sleeptimeline = {
            TimeEvent(0 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/crocodog/sleep") end),
            TimeEvent(20 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/crocodog/sleep") end),
        },
    })
