...
BIRD_TYPES[GROUND.QUAGMIRE_PEATFOREST] = { "robin", "crow" }
BIRD_TYPES[GROUND.QUAGMIRE_PARKFIELD] = { "crow" }
BIRD_TYPES[GROUND.QUAGMIRE_PARKSTONE] = { "quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_GATEWAY] = { "robin","quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_SOIL] = { "crow" }
