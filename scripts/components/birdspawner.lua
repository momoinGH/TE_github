...
BIRD_TYPES[GROUND.FOUNDATION] = {"quagmire_pigeon"}
BIRD_TYPES[GROUND.FIELDS] = {"robin","crow"}
BIRD_TYPES[GROUND.SUBURB] = {"robin","crow","quagmire_pigeon"}
BIRD_TYPES[GROUND.PAINTED] =  {"kingfisher","crow"}
BIRD_TYPES[GROUND.PLAINS] =  {"robin","crow","kingfisher"}
...
BIRD_TYPES[GROUND.QUAGMIRE_PEATFOREST] = { "quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_PARKFIELD] = { "quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_PARKSTONE] = { "quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_GATEWAY] = { "quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_SOIL] = { "quagmire_pigeon"}
BIRD_TYPES[GROUND.QUAGMIRE_CITYSTONE] = { "quagmire_pigeon"}
