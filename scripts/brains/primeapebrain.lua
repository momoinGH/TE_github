...
local function AssistPlayer(inst)
    ...
    if inst.CanThrowItems then
        ...
        local ents = TheSim:FindEntities(pt.x, pt.y, pt.z, SEE_FOOD_DIST * 2, nil,
            { "aquatic", "falling", "FX", "NOCLICK", "DECOR", "INLIMBO" })
    ...
    local root = PriorityNode(
        {
            ...
            WhileNode(function() return not self.inst.components.timer:TimerExists("go_home_delay") end,
