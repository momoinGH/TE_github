...
local peach_juice =
{
	...
	test = function(cooker, names, tags) return (names.peach or names.grilled_peach) and
		(names.peach or names.grilled_peach) >= 2 and tags.sweetener and tags.water and not tags.meat and not tags.egg and
		not tags.monster end,
	priority = 100,
	weight = 1,
...
local potion =
{
	...
	test = function(cooker, names, tags) return tags.peachy and tags.goddessmagic and tags.loaf and
		(names.peach or names.grilled_peach) end,
	priority = 100,
	weight = 1,
	foodtype = FOODTYPE.GOODIES,
	health = 75,
...
AddRecipe2("magicpowder",
	...
	"nightmarefuel", 8), Ingredient("cutgreengrass", 8, "images/inventoryimages/cutgreengrass.xml") }, TECH.GODDESS_TWO,
...
AddRecipe2("windyfan",
	{ Ingredient("usedfan", 1, "images/inventoryimages/usedfan.xml"), Ingredient("magicpowder", 8,
		...
		"images/inventoryimages/forbidden_fruit.xml") }, TECH.GODDESS_TWO, { atlas =
"images/inventoryimages/windyfan.xml" }, { "CRAFTING_STATION" })
