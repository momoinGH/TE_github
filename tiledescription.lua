function SetInfo()
	...
	local NEW_TILE_DESCRIPTION =
	{
		...
		water_mangrove = { specs = { name = "water_mangrove" }, nil, layer = 40, isfloor = true, hard = true, cannotbedug = true }, -- frost
		...
		deeprainforest = { specs = { name = "deeprainforest" }, turf = { { "turf_deeprainforest" } }, layer = 25, hard = true, cannotbedug = true },
		rainforest = { specs = { name = "rainforest" }, turf = { { "turf_rainforest" } }, layer = 25 },
		painted = { specs = { name = "deeprainforest" }, turf = { { "turf_painted" } }, layer = 25, hard = true, cannotbedug = true },
		battleground = { specs = { name = "deeprainforest" }, turf = { { "turf_battleground" } }, layer = 25, hard = true, cannotbedug = true },
		gasjungle = { specs = { name = "deeprainforest" }, turf = { { "turf_gasjungle" } }, layer = 25, hard = true, cannotbedug = true },
