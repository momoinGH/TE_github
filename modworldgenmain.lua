...
if GetModConfigData("kindofworld") == 5 then
	...
	AddRoom("BG_cultivated_base", {
		colour = { r = 1.0, g = 1.0, b = 1.0, a = 0.3 },
		value = GROUND.FIELDS,
		tags = { "ExitPiece", "hamlet" , "Junkyard_Spawner"},
		contents = {
...
elseif GetModConfigData("kindofworld") == 20 then
	...
	AddRoom("MAINBG_cultivated_base", {
		colour = { r = 1.0, g = 1.0, b = 1.0, a = 0.3 },
		value = GROUND.FIELDS,
		tags = { "ExitPiece" , "Junkyard_Spawner"},
		contents = {
			distributepercent = 0.06, ---0.1
			distributeprefabs =
			{
	...
	AddRoom("BeachSkull", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.BEACH,
		tags = { "RoadPoison", "Chester_Eyebone", "tropical" , "Junkyard_Spawner"},
		contents = {
			distributepercent = .25,
			distributeprefabs =
			{
	...
	AddRoom("JungleClearing", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.JUNGLE,
		tags = { "RoadPoison", "Chester_Eyebone", "tropical", "StagehandGarden", "Terrarium_Spawner", "StatueHarp_HedgeSpawner", "CharlieStage_Spawner" , "Junkyard_Spawner"},
		contents = {
			countstaticlayouts = {
				["MushroomRingLarge"] = function()
	...
	AddRoom("JungleDenseHome", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.JUNGLE,
		tags = { "RoadPoison", "tropical", "Junkyard_Spawner" },
		contents = {
			countstaticlayouts =
			{
				["LivingJungleTree"] = function() return (math.random() > LIVINGJUNGLETREE_CHANCE and 1) or 0 end
	...
	AddRoom("JungleDenseBerries", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.JUNGLE,
		tags = { "Chester_Eyebone", "RoadPoison", "tropical" , "Junkyard_Spawner"},
		contents = {
			countstaticlayouts =
			{
				["LivingJungleTree"] = function() return (math.random() > LIVINGJUNGLETREE_CHANCE and 1) or 0 end
	...
	AddRoom("JungleDenseMedHome", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.JUNGLE,
		tags = { "ExitPiece", "Chester_Eyebone", "tropical", "Junkyard_Spawner" },
		contents = {
			countstaticlayouts =
			{
				["LivingJungleTree"] = function() return (math.random() > LIVINGJUNGLETREE_CHANCE and 1) or 0 end
	...
	AddRoom("MAINDoydoyBeach1", {
		colour = { r = .66, g = .66, b = .66, a = .50 },
		value = GROUND.JUNGLE,
		tags = { "RoadPoison", "Chester_Eyebone" , "Junkyard_Spawner"},
		contents = {
	...
	AddRoom("MAINJungleDenseHome", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.JUNGLE,
		tags = { "RoadPoison", "Junkyard_Spawner" },
		contents = {
			countstaticlayouts =
			{
				["LivingJungleTree"] = function() return (math.random() > LIVINGJUNGLETREE_CHANCE and 1) or 0 end
	...
	AddRoom("MAINJungleDenseBerries", {
		colour = { r = .5, g = 0.6, b = .080, a = .10 },
		value = GROUND.JUNGLE,
		tags = { "Chester_Eyebone", "RoadPoison" , "Junkyard_Spawner"},
		contents = {
			countstaticlayouts =
			{
				["LivingJungleTree"] = function() return (math.random() > LIVINGJUNGLETREE_CHANCE and 1) or 0 end
		...
		local function LevelPreInit(level)
			if level.location == "cave" then
				...
				if GetModConfigData("underwater") then
					...
					if GetModConfigData("Hamlet") ~= 5 or GetModConfigData("kindofworld") == 5 or GetModConfigData("enableallprefabs") == true then table.insert(level.tasks,
							"UnderwaterExit2") end
				end
			end
