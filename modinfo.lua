local function en_zh_zht(en,zh,zht)
	if locale == "zh" or locale == "zhr" or locale == "chs" or locale =="ch" then return zh or en -- 简体中文
	elseif locale == "zht" or locale == "tc" or locale == "cht" then return zht or zh or en -- 繁体中文
	else return en end -- 英文
end

name	=  en_zh_zht("Tropical Experience Return of Them","热带体验：31addtest","熱帶體驗：船難哈姆雷特聯機版三合一")
...
server_filter_tags = {"shipwrecked", "tropical experience", "Hamlet", "Economy", "itens", "biome", "world", "gen", "money", "coins", "house", "home", "boats", "light", "hats", "boss", "companion", "endless", "ruins", "gun", "hard", "trade", "vagner","三合一","热带体验"}
...
configuration_options =
{
	...
	title(en_zh_zht("KIND OF WORLD"					,"世界种类","世界種類")),

		{
			...
			{
				{
					description =  en_zh_zht("hamlet","仅哈姆雷特世界","僅哈姆雷特世界"), data = 5,
					hover	=  en_zh_zht(
				...
				{
					description =  en_zh_zht("shipwrecked","仅海难世界","僅船難世界"), data = 10,
					hover	=  en_zh_zht(
				...
				{
					description =  en_zh_zht("custom","自定义世界","自定義世界"), data = 15,
					hover	=  en_zh_zht(
				...
				{
					description =  en_zh_zht("Sea World","海洋世界"), data = 20,
					hover	=  en_zh_zht(
	...
	title(en_zh_zht("for hamlet world"				,"仅哈姆雷特世界设置","僅哈姆雷特世界設置")),

		{
			...
			{
				{
					description = en_zh_zht("Disabled","禁用"), data = 0,
					hover	=  en_zh_zht(
				...
				{
					description =  en_zh_zht("Enabled","启用","啟用"), data = 1,
					hover	=  en_zh_zht(
...

		{
			...
			label	=  en_zh_zht("Together Caves","联机版洞穴","聯機版洞穴"),
			hover	=  en_zh_zht(
...

		{
			...
			{
				{
					description = en_zh_zht("Compact","小型"), data = 1,
					hover	= en_zh_zht(
				...
				{
					description = en_zh_zht("Default","默认","默認"), data = 2,
					hover	= en_zh_zht(
				...
				{
					description = en_zh_zht("Bigger","大型"), data = 3,
					hover	= en_zh_zht(
...

		{
			...
			default = false,
			options =	{
							{description = en_zh_zht("YES","启用","啟用"), data = true,
							hover	= en_zh_zht(
								"Less rooms on pig ruins",
								"将减少房间数量",
								"將減少房間數量")},
							{description = en_zh_zht("NO","禁用"), data = false,
							hover	= en_zh_zht(
								"Standard Quantity",
								"默认数量",
								"默認數量")},
	...
	title(en_zh_zht("for shipwrecked world"			,"仅海难世界设置","僅船難世界設置")),
...

		{
			...
			options =	{
							...
							hover = en_zh_zht(
								...
								"禁止生成冰霜岛屿群系",
								"禁止生成冰霜島嶼羣系")},
							{description = en_zh_zht("YES","启用","啟用"), data = 10,
							hover = en_zh_zht(
...

		{
			...
			options =	{
							{description = en_zh_zht("NO","禁用"), data = 0,
							hover = en_zh_zht(
								"Moon continent will not be generated",
								"禁用月岛生成",
								"禁用月島生成")},
							{description = en_zh_zht("YES","启用","啟用"), data = 1,
							hover = en_zh_zht(
	...
	title(en_zh_zht("for custom world"				,"自定义世界设置","自定義世界設置")),
...

		{
			...
			options =	{
							...
							{
								description = en_zh_zht("Main land","主大陆","主大陸"), data = 20,
								hover	= en_zh_zht(
							...
							{
								description = en_zh_zht("Continent","新大陆","新大陸"), data = 10,
								hover	= en_zh_zht(
							...
							{
								description = en_zh_zht("Islands","岛屿","島嶼"), data = 15,
								hover	= en_zh_zht(
...

		{
			...
			options =	{
							...
							{
								description = en_zh_zht("Arquipelago","群岛","羣島"), data = 25, 
...

		{
			...
			options =
			{
				...
				{
					description = en_zh_zht("Main land","主大陆","主大陸"), data = 10,
					hover = en_zh_zht(
				...
				{
					description = en_zh_zht("Continent","新大陆","新大陸"), data = 15,
					hover = en_zh_zht(
				...
				{
					description = en_zh_zht("Island","岛屿","島嶼"), data = 20,
					hover = en_zh_zht(
...

		{
			...
			hover	= en_zh_zht(
				...
				"將在洞穴伺服器生成一個與聯機版洞穴生態迥異的哈姆雷特羣系洞穴區域"),
			default = 1,	
			options =
			{
				{description = en_zh_zht("Disabled","禁用"), data = 0, hover = en_zh_zht("This biome will not be generated","禁用该生态群系生成","禁用該生態羣系生成")},
	...
	title(en_zh_zht("for all worlds"				,"应用于整个世界的设置","應用於整個世界的設置")),

		{
			...
			hover	= en_zh_zht(
				...
				"在世界中生成火山，完整模式可游历火山内部\n需要添加洞穴（仅影响自定义世界和海难世界）",
				"在世界中生成火山，完整模式可遊歷火山內部\n需要添加洞穴（僅影響自定義世界和船難世界）"),
			default = true,	
			options =	{
							{
								description = en_zh_zht("Complete","完整"), data = true,
								hover = en_zh_zht(
									"Will Generate a complete volcano in terms of content, need caves enabled",
									"可在海难上游历火山\n需要添加洞穴",
									"可在船難上游歷火山\n需要添加洞穴")},
							{
								description = en_zh_zht("Edge","小型"), data = false,
								hover = en_zh_zht(
		...
		{
			name	= "forge",
			label	= en_zh_zht("Forge Arena","熔炉","熔爐"),
			hover	= en_zh_zht(
			...
			default = 1,	
			options =	{
							{description =  en_zh_zht("Enabled","启用","啟用"), data = 1, hover = en_zh_zht("Will generate the forge arena","启用熔炉区域生成","啟用熔爐區域生成")},
							{description = en_zh_zht("Disabled","禁用"), data = 0, hover = en_zh_zht("Will not generate the forge arena","禁用熔炉区域生成","禁用熔爐區域生成")},
						},
		},

		{
			...
			options =	{
							{
								description =  en_zh_zht("Enabled","启用","啟用"), data = true,
								hover = en_zh_zht("Generate the Underwater Biome, The caves need be enabled to work",
								"启用海底生态群系生成\n需要添加洞穴",
								"啟用海底生態羣系生成\n需要添加洞穴")
							},
							{
								description = en_zh_zht("Disabled","禁用"), data = false,
								hover = en_zh_zht(
...

		{
			...
			options =	{
							...
							{
								description = en_zh_zht("Island","岛屿","島嶼"), data = 15,
								hover = en_zh_zht(
	...
	title(en_zh_zht("WEATHER SETTINGS"				,"天气设置","天氣設置")),

		{
			...
			options =
			{
				...
				{
					description = en_zh_zht("Tropical Zone","海难区域","船難區域"), data = 10,
					hover = en_zh_zht(
				...
				{
					description = en_zh_zht("All world","全地图","全地圖"), data = 20,
					hover = en_zh_zht(
...

		{
			...
			options =
			{
				...
				{
					description = en_zh_zht("Tropical-Hamlet","海难区域和哈姆雷特区域","船難區域和哈姆雷特區域"), data = 10,
					hover = en_zh_zht(
...

		{
			...
			options =
			{
				{description = en_zh_zht("Disabled","禁用"), data = 5, hover = en_zh_zht("Disabled","禁用")},
				{
					description = en_zh_zht("Hamlet Zone","哈姆雷特区域","哈姆雷特區域"), data = 10, 
					hover = en_zh_zht(
	...
	title(en_zh_zht("SHARD-DEDICATED"				,"多层专用服务器设置","多層專用伺服器設定")),
...

		{
			...
			options =
			{
				...
				{
					description = en_zh_zht("Lobby Only","仅大厅","僅大廳"), data = 30, 
					hover = en_zh_zht(
	...
	title(en_zh_zht("OTHER MODS (need mod enabled)"	,"群系扩展(需要启用模组)","羣系擴展(需要啟用模組)")),

		{
			...
			{
				{
					description = en_zh_zht("Mainland","主大陆","主大陸"), data = 10, 
					hover = en_zh_zht(
				...
				{
					description = en_zh_zht("Grove","小樱花林","小櫻花林"), data = 30, 
					hover = en_zh_zht(
				...
				{
					description = en_zh_zht("Archipelago","群岛","羣島"), data = 40, 
					hover = en_zh_zht(
				...
				{
					description = en_zh_zht("Moon Morphis","月岛","月島"), data = 50, 
					hover = en_zh_zht(
	...
	title(en_zh_zht("LUAJIT"                        ,"迷宫玩法","迷宮玩法")),
		{
			name	= "luajit",
			label	= en_zh_zht("luajit","迷宫玩法","迷宮玩法"),
			hover	= en_zh_zht(
				"luajit will works but Will disable minimaps on pig ruins entrance.",
				"启用迷宫玩法会使古代猪人遗迹入口房间地面上的地图不再显示\n(同时小型古代猪人遗迹设置将失效)",
				"啟用迷宫玩法會使古代豬人遺跡入口房間地面上的地圖不再顯示\n(同時小型古代猪人遺跡設定將失效)"),
			default = false,
			options =
			{
				{description = en_zh_zht("YES","启用","啟用"), data = true, hover = en_zh_zht("Enabled","启用","啟用")},
				{description = en_zh_zht("NO","禁用"), data = false, hover = en_zh_zht("Disabled","禁用")},
			},			
		},

		------------ninguem pode ver isso------------------------	
		{
		name	= en_zh_zht("megarandomCompatibilityWater","兼容超级随机世界生成","兼容超級隨機世界生成"),
		default = false,
		},
}
